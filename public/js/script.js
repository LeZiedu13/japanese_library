...
input.addEventListener('keyup',()  => {
    ...
    let myRequest = new Request('index.php?route=search', {        // le JS demande à executer le php + param comme POST en methode et type texte
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    affichageHeure();
        ...
        /*======  sons furin     =====*/
            ...
            let sound = new Audio('public/sounds/furin3.mp3');
            sound.play();
