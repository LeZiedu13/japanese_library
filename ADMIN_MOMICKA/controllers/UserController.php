...
class UserController    {
    ...
    public function advertise(){        //j'affiche l'accueil en montrant les ouvrages
    ...
    public function addUserForm(){          // j'affiche le formulaire création compte
    ...
    public function submitUserForm(){    // je soumets le formulaire
      ...
      require('../public/lib/messages.php');     
           ...
           if(count($errors) == 0) {
                ...
                $data = [
                            ...
                            $addUser['addCp'],
                            $addUser['addCity'],
                            3  // Role USER par défaut, peut uniquement ajouter au panier
                ];
    ...
    public function submitConnectForm(){   //se connecter au site
